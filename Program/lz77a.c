...
int main(int argc, char *argv[])
{
    ...
    if (argc != 4)
    {
        printf("\n'prog e file1 file2' encodes file1 into file2.\n"
               "'prog d file2 file1' decodes file2 into file1.\n");
        return EXIT_FAILURE;
    }
    ...
    if (toupper(*argv[1]) == 'E')
    {
        ...
        original=ftell(infile);
        compressed=ftell(outfile);

        printf("\nSize of the original file is %ld Bytes\n",original);
        printf("\nSize of the compressed file is %ld Bytes\n",compressed);
    ...
    else
    {
        ...
        compressed=ftell(infile);
        decompressed=ftell(outfile);

        printf("\nSize of the compressed file is %ld Bytes\n",compressed);
        printf("\nSize of the decompressed file is %ld Bytes\n",decompressed);
